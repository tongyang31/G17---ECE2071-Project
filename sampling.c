...
/* USER CODE BEGIN PV */
uint16_t raw_ADC_value = 0; //temporarily store the result of the latest ADC conversion
uint8_t raw_ADC_value_1[2] = {0};//broken down into 2 bytes and stored in the 8-bit
uint16_t temp = 0; // temporary variable to assist breaking of the 16-bit ADC value into 2 bytes using bitwise manipulation.
/* USER CODE END PV */
